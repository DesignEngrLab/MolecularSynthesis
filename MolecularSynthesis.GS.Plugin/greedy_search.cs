...
namespace MolecularSynthesis.GS.Plugin
{
    public class greedy_search : SearchProcess
    {
        ...
        protected override void Run()
        {
            ...
            List<double> greedySearchQueue = new List<double>();
            ...
            System.IO.File.WriteAllLines(@"/nfs/hpc/share/zhangho2/MolecularSynthesis/examples_Kai/GreedySearchRecord.txt", resultCollector);
