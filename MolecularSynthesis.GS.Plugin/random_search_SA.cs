...
{
    public class random_search_SA : SearchProcess
    {
        // give desiredMoment
        ...
        public random_search_SA(GlobalSettings settings) : base(settings)
        {
            RequireSeed = true;
        ...
        protected override void Run()
        {
            ...
            try
            {
                for (int i = 0; i < TotalNumber; i++)
                {
                    ...
                    var score = loss(candidate, desiredPD);
            ...
            System.IO.File.WriteAllLines(@"/nfs/hpc/share/zhangho2/MolecularSynthesis/examples/RandomSearchRecord.txt", resultCollector);
