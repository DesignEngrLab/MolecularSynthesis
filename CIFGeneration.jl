...
for filename in filelist
    ...
    #xyz_filename = ARGS[1]
        ...
        atoms = read_xyz(joinpath(homedir(), "Documents", "GitHub", "MolecularSynthesis", "examples", xyz_filename))
        ...
        filename = replace(filename, "xyz" => "cif")
        write_cif_Kai(tobacco_crystal, filename)
