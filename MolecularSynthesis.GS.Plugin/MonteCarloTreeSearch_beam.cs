...
{
    public class MonteCarloTreeSearch_beam : SearchProcess
    {
        // give desiredMoment
        ...
        public MonteCarloTreeSearch_beam(GlobalSettings settings) : base(settings)
        {
            RequireSeed = true;
        ...
        {
            get { return "MonteCarloTreeSearch_beam"; }
        }
