...
{
    public class randomSearch_SA : SearchProcess
    {
        // give desiredMoment
        ...
        public randomSearch_SA(GlobalSettings settings) : base(settings)
        {
            RequireSeed = true;
                ...
                Parallel.ForEach(candidateThreadDictionary, kvp =>
                 {
                     try
                     {
                         ...
                         var filename6 = filename5.Split(".")[0] + ".sa";
