...
{
    public class Test_cifgeneration : SearchProcess
    {
        public override string text => "Test_cifgeneration";
        //public string filename = @"..\..\..\..\ForCiftest";
        //public string extension = "xyz";


        //deault constructor
        public Test_cifgeneration(GlobalSettings settings) : base(settings)
        {
            RequireSeed = true;
