...
{
    public class MCTS_zeo_AV : SearchProcess
    {
        // give desiredMoment
        ...
        public MCTS_zeo_AV(GlobalSettings settings) : base(settings)
        {
            RequireSeed = true;
        ...
        protected override void Run()
        {
            ...
            //{
                ...
                var filename = "MCTS_AV3.98_e50" + Thread.CurrentThread.ManagedThreadId.ToString();
