...
{
    public class MonteCarloTreeSearch_leaf_para : SearchProcess
    {
        // give desiredMoment
        ...
        public MonteCarloTreeSearch_leaf_para(GlobalSettings settings) : base(settings)
        {
            RequireSeed = true;
        ...
        {
            get { return "MonteCarloTreeSearch_leaf_para"; }
        }
